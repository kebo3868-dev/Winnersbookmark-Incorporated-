...
> = {
  LIVE: {
    ...
    border: 'border-signal-live/40',
    rule: 'border-signal-live/70',
  },
  PILOT: {
    label: 'Private pilot',
    dot: 'bg-signal-building',
    text: 'text-signal-building',
    border: 'border-signal-building/40',
    rule: 'border-signal-building/70',
  },
  IN_DEVELOPMENT: {
  ...
  COMING_SOON: {
    label: 'Coming soon',
    dot: 'bg-signal-planned',
    text: 'text-signal-planned',
    border: 'border-signal-planned/40',
    rule: 'border-signal-planned/70',
  },
};
